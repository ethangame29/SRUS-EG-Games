...
> All of the above functions are hash functions because they all take in a str which the function then produces and returns a hash.
> All three take a str for the key and an int for the size, they then hash the key and modulo based on the size.
...
> The first hash function is simple and easy to setup, however basic hash functions like this can be prone to hash collision.
> The second hash function is far more simple as it uses a built-in hash function, however you do not have control over how this one works.
> The last hash function
